...
Route::put('categoriaProductos/edit/{id}','App\Http\Controllers\CategoriaProductoController@update');
...
Route::put('producto/edit/{id}','App\Http\Controllers\ProductoController@update');
